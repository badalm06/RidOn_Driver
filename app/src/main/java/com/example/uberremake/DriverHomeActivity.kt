...
import com.example.uberremake.Common.buildWelcomeMessage
import com.example.uberremake.databinding.ActivityDriverHomeBinding
import com.example.uberremake.login.EditProfileActivity
...
class DriverHomeActivity : AppCompatActivity() {
    ...
    private fun init() {
        ...
        txt_phone.text = Common.currentUser?.number ?: "N/A"
        val imageUrl = Common.currentUser?.profileImageUrl
